    ...
    <div className="pricing-root">
      <div className="wrap">
        ...
        <style jsx>{`
          ...
          .grid { display: grid; grid-template-columns: minmax(200px, 1.5fr) repeat(${PLAN_COLUMNS}, 1fr); gap: 0; align-items: stretch; }
          ...
          .pricing-root :global(.frow) { display: grid; grid-template-columns: minmax(200px, 1.5fr) repeat(${PLAN_COLUMNS}, 1fr); border-top: 1px solid var(--line); }
