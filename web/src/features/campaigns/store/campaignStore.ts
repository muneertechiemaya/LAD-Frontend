...
const defaultStepData: Record<StepType, Partial<StepData>> = {
  ...
  whatsapp_broadcast: { title: 'Send WhatsApp', whatsappMessage: 'Hi {{first_name}},...', whatsappTemplate: '' },
  whatsapp_message: { title: 'Send WhatsApp', whatsappMessage: 'Hi {{first_name}},...', whatsappTemplate: '' },
  whatsapp_followup: { title: 'Send WhatsApp', whatsappMessage: 'Hi {{first_name}},...', whatsappTemplate: '' },
  whatsapp_template: { title: 'Send WhatsApp', whatsappMessage: 'Hi {{first_name}},...', whatsappTemplate: '' },
  voice_agent_call: { title: 'Voice Agent Call', voiceAgentId: '', voiceTemplate: '', voiceContext: '' },
  voice_call: { title: 'Voice Agent Call', voiceAgentId: '', voiceTemplate: '', voiceContext: '' },
  voice_script: { title: 'Voice Agent Call', voiceAgentId: '', voiceTemplate: '', voiceContext: '' },
  ...
  website_visit: { title: 'Website Visit' },
