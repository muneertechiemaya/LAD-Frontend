  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <DialogHeader className="px-6 pt-5 pb-4 border-b border-slate-100 dark:border-slate-800/80 bg-white dark:bg-[#000724] flex-shrink-0 flex-row items-center justify-between">
          <DialogTitle className="flex items-center gap-3 text-base font-semibold text-slate-900 dark:text-white">
            ...
            <div className="flex flex-col gap-0.5 min-w-0">
              <span className="truncate text-slate-900 dark:text-white text-base font-semibold">
        ...
        {/* Body Container */}
        <div className="flex-1 flex flex-col min-h-0 overflow-hidden bg-slate-50/30 dark:bg-[#000724]">
            ...
            <>
              ...
              <div className="px-6 pt-5 pb-2 flex items-center gap-3 flex-shrink-0">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className="h-10 px-4 rounded-xl text-xs font-semibold border-blue-200 dark:border-blue-500/30 bg-blue-50/50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-500/20 transition-all shrink-0"
                  onClick={() => {
                    setFormName(''); setFormSubject(''); setFormBody(''); setFormError('');
                    setView('compose');
                  }}
              ...
              <div className="flex-1 min-h-0 overflow-y-auto px-6 py-4 space-y-2">
                {loadingTemplates ? (
                  <div className="flex flex-col items-center justify-center py-20">
                    ...
                    <span className="text-sm text-slate-500 dark:text-slate-400 mt-2">Loading templates...</span>
                  </div>
                ) : filtered.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-20 text-slate-500 dark:text-slate-400">
                    <FileText className="h-10 w-10 mb-2 text-slate-400 dark:text-slate-600 opacity-50" />
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <p className="text-sm font-semibold truncate text-slate-900 dark:text-slate-100 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                              {tpl.name}
                            </p>
                            {tpl.category && (
                              <Badge variant="outline" className="text-[10px] font-medium px-2 py-0.5 bg-blue-50 dark:bg-blue-950/30 text-blue-600 dark:text-blue-400 border-blue-200 dark:border-blue-800/40 rounded-md">
                                {tpl.category}
                              </Badge>
                            )}
                        ...
                        <button
                          ...
                          className="opacity-0 group-hover:opacity-100 h-8 w-8 flex items-center justify-center rounded-lg hover:bg-red-50 dark:hover:bg-red-500/10 text-slate-400 dark:text-slate-500 hover:text-red-600 dark:hover:text-red-400 transition-all flex-shrink-0"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                ...
                <div className="lg:col-span-7 space-y-4">
                  <div className="space-y-1.5">
                    <label className="text-xs font-semibold text-slate-600 dark:text-slate-300 uppercase tracking-wider">Template Name</label>
                    <Input
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-semibold text-slate-600 dark:text-slate-300 uppercase tracking-wider">Subject Line</label>
                    <Input
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-semibold text-slate-600 dark:text-slate-300 uppercase tracking-wider">Email Body</label>
                    <textarea
                ...
                <div className="lg:col-span-5 space-y-4">
                  <div className="p-5 rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-slate-50/60 dark:bg-[#00051d]/60 space-y-3">
                    ...
                    <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                      Saved templates can be reused across all your email broadcast campaigns. You can personalize each message with dynamic merge tags like <code className="text-blue-600 dark:text-blue-400 font-semibold">{`{name}`}</code>, <code className="text-blue-600 dark:text-blue-400 font-semibold">{`{first_name}`}</code>, and <code className="text-blue-600 dark:text-blue-400 font-semibold">{`{company}`}</code>.
                    </p>
                  </div>
                  ...
                  <div className="p-5 rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-[#00051d] space-y-3">
                    ...
                    <div className="flex items-center gap-3 p-3.5 rounded-xl bg-slate-50/70 dark:bg-[#000724] border border-slate-200/80 dark:border-slate-800">
                      <div
                        className="h-8 w-8 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 shadow-xs"
                        style={{ backgroundColor: group.color }}
                      >
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="text-sm font-semibold truncate text-slate-900 dark:text-white">{group.name}</p>
                        <p className="text-xs text-slate-500 dark:text-slate-400">{group.member_count} recipients via {providerLabel}</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex-1 min-h-0 overflow-y-auto px-6 py-5">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                ...
                <div className="lg:col-span-7 space-y-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-semibold text-slate-600 dark:text-slate-300 uppercase tracking-wider">Body Content</label>
                    <textarea
                    ...
                    {attachments.length > 0 ? (
                      <div className="flex flex-wrap gap-2 pt-1">
                        {attachments.map((file, idx) => (
                          <span
                            key={idx}
                            className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-100 dark:bg-[#000724] border border-slate-200 dark:border-slate-800 text-xs text-slate-800 dark:text-slate-200 max-w-[220px] shadow-2xs"
                          >
                            <Paperclip className="h-3.5 w-3.5 text-slate-400 dark:text-slate-500 flex-shrink-0" />
                            <span className="truncate">{file.name}</span>
                            <button
                              type="button"
                              onClick={() => setAttachments(prev => prev.filter((_, i) => i !== idx))}
                              className="ml-1 text-slate-400 dark:text-slate-500 hover:text-red-500 dark:hover:text-red-400 transition-colors flex-shrink-0"
                            >
                ...
                <div className="lg:col-span-5 space-y-4">
                  ...
                  <div className="rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-[#00051d] p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[11px] text-slate-500 dark:text-slate-400">{group.name}</span>
                    </div>
                    <div className="flex flex-wrap gap-1.5 max-h-48 overflow-y-auto pr-1">
                      {group.members.slice(0, 20).map(m => (
                        <span key={m.id} className="text-xs bg-slate-50 dark:bg-[#000724] text-slate-800 dark:text-slate-200 border border-slate-200 dark:border-slate-800 rounded-lg px-2.5 py-1 truncate max-w-[170px] shadow-2xs">
          ...
          {view === 'sending' && (
            <div className="flex-1 flex flex-col items-center justify-center py-16 px-6 text-center gap-4">
              <div className="h-16 w-16 rounded-full bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20 flex items-center justify-center">
                <Loader2 className="h-8 w-8 animate-spin text-blue-600 dark:text-blue-400" />
              </div>
              <div>
                <p className="font-semibold text-lg text-slate-900 dark:text-white">Sending campaign…</p>
            ...
            <div className="flex items-center justify-end gap-2.5 sm:gap-3 w-full sm:w-auto">
              {view === 'compose' && (
                <>
                  <Button
                    variant="outline"
                    size="sm"
                    className="h-9 sm:h-10 px-4 sm:px-5 rounded-xl border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800/60 text-slate-700 dark:text-slate-300 font-medium flex-1 sm:flex-initial"
                  ...
                  <Button
                    size="sm"
                    className="h-9 sm:h-10 px-5 sm:px-6 rounded-xl gap-2 bg-[#0B1957] hover:bg-[#0B1957]/90 dark:bg-blue-600 dark:hover:bg-blue-500 text-white font-semibold shadow-sm flex-1 sm:flex-initial"
              ...
              {view === 'preview' && (
                <>
                  ...
                  <Button
                    size="sm"
                    className="h-9 sm:h-10 px-5 sm:px-7 rounded-xl gap-2 bg-[#0B1957] hover:bg-[#0B1957]/90 dark:bg-blue-600 dark:hover:bg-blue-500 text-white font-semibold shadow-sm flex-1 sm:flex-initial"
                    onClick={handleSend}
              ...
              {view === 'done' && (
                <Button
                  size="sm"
                  className="h-9 sm:h-10 px-6 sm:px-8 rounded-xl gap-2 bg-[#0B1957] hover:bg-[#0B1957]/90 dark:bg-blue-600 dark:hover:bg-blue-500 text-white font-semibold shadow-sm w-full sm:w-auto"
