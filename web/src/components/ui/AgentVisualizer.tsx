...
// ── Brand constants ──────────────────────────────────────────────────────────
// Swapped hardcoded hex for a semantic CSS variable to natively support dark mode
  ...
  return (
      <svg
          ...
          style={{
            display: 'block',
            flexShrink: 0,
            // Inline CSS variable mapping Tailwind utility variants safely without structural rewrites
            // Sets a bright glowing blue (#3b82f6) for dark mode configurations
            '--visualizer-brand': 'rgba(11, 25, 88, 1)'
          }}
          className="[--visualizer-brand:#0b1958] dark:[--visualizer-brand:#3b82f6]"
      >
        <defs>
          <clipPath id={clipId}>
