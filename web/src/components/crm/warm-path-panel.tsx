      ...
      <LadCard>
        ...
        {!open ? (
            ...
            >
              ...
              <span className="text-[11.5px] font-semibold inline-flex items-center gap-1 text-[#0B1957] dark:text-white">
...
function GraphNode({
  ...
  return (
      ...
      >
        ...
        {/* Dynamic Halo Rings adapting natively to light or dark color vectors */}
        <circle
            r={r}
            fill={color}
            className="dark:!fill-[var(--node-color)]"
            style={{
              transition: 'opacity 150ms',
              ['--node-color' as any]: darkColor || color
            }}
            opacity={isHover ? 0.22 : 0.12}
        />

        {/* Outer borders dynamically adapting to theme configurations */}
        <circle
            r={r}
            fill="white"
            ...
            style={{
              ...
              stroke: typeof window !== 'undefined' && document.documentElement.classList.contains('dark') ? (darkColor || color) : color
            }}
