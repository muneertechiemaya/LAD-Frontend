...
export default function WorkflowPreviewPanel({
  ...
  return (
      <div
          ...
          className="[--panel-bg:#ffffff] [--canvas-bg:#fafafa] [--border-color:#f0f0f0] [--text-main:#111827] [--text-muted:#9ca3af] [--dot-color:#e5e7eb] [--controls-bg:rgba(255,255,255,0.95)] [--btn-bg:#f3f4f6] [--btn-text:#111827] [--popover-bg:#ffffff] dark:[--panel-bg:#0b0f19] dark:[--canvas-bg:#0d121f] dark:[--border-color:#1e293b] dark:[--text-main:#f8fafc] dark:[--text-muted:#64748b] dark:[--dot-color:#334155] dark:[--controls-bg:rgba(15,23,42,0.95)] dark:[--btn-bg:#1e293b] dark:[--btn-text:#f8fafc] dark:[--popover-bg:#151f32]"
      >
        {/* ─── HEADER ─── */}
