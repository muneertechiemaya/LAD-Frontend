        ...
        >
          ...
          <div className="bg-gray-50 dark:bg-[#000c3b] px-3 py-2 border-b border-gray-200 dark:border-gray-800 flex items-start justify-between gap-2">
            ...
            <button
              ...
              className="flex-shrink-0 px-2 py-1 text-xs bg-primary dark:bg-blue-500 text-white rounded hover:bg-blue-700 dark:hover:bg-blue-600 disabled:opacity-50 whitespace-nowrap font-medium"
            >
