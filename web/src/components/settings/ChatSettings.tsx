              ...
              {linkedinFollowup.schedule_hours.map((hours, idx) => (
                <div key={idx} className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="text-gray-300 dark:text-gray-600 hover:text-red-500 dark:hover:text-red-400 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
