...
export const WhatsAppIntegration: React.FC = () => {
  ...
  const StatusIcon = () => {
    switch (status) {
      ...
      case 'qr_scanning':
      case 'connecting': return <RefreshCw className="h-5 w-5 text-blue-500 dark:text-blue-400 animate-spin" />;
      case 'error': return <AlertCircle className="h-5 w-5 text-red-500 dark:text-red-400" />;
      default: return <WifiOff className="h-5 w-5 text-gray-400 dark:text-gray-500" />;
    }
  };
