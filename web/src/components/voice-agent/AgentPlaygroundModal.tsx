...
export function AgentPlaygroundModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-fit sm:max-w-fit w-fit p-0 border-0 overflow-visible bg-transparent !bg-transparent dark:!bg-transparent shadow-none dark:shadow-none focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 outline-none" showCloseButton={false}>
