...
export function MediaGenerationModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent
        className="max-w-fit w-fit sm:max-w-fit sm:w-fit p-0 border-0 overflow-hidden bg-white dark:bg-[#000724] shadow-none focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 outline-none"
