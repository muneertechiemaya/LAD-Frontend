...
const getRequiredFields = (stepType: StepType): string[] => {
  const required: Record<StepType, string[]> = {
    ...
    whatsapp_broadcast: ['whatsappAccountId', 'whatsappMessage'],
    whatsapp_message: ['whatsappAccountId', 'whatsappMessage'],
    whatsapp_followup: ['whatsappAccountId', 'whatsappMessage'],
    whatsapp_template: ['whatsappAccountId', 'whatsappMessage'],
    voice_agent_call: ['voiceAgentId'],
    voice_call: ['voiceAgentId'],
    voice_script: ['voiceAgentId'],
